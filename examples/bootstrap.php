...
<head>
  ...
  <title>'littleTable' Bootstrap example</title>
  <meta name="description" content="An simple javascript interactive table built using Bootstrap and AlpineJS" />
</head>
<body>
    <section class="section">
        <div class="container">
            <h1 class="display-4">LittleTable with Bootstrap</h1>
